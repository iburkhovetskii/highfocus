...
def get_question_1_keyboard() -> ReplyKeyboardMarkup:
    ...
    options = [
        "Быстро собираюсь, делаю план и иду по нему. (🔒 Компульсивный)",
        "Начинаю тревожиться и прокручивать негативные сценарии. (😰 Тревожный)",
        "Чувствую упадок и прокрастинирую. (😔 Депрессивный)",
        "Заряжаюсь энергией, но могу вспылить. (🌋 Вспыльчивый)",
        "Бросаюсь в задачу с азартом, но хаотично. (⚡ Импульсивный)",
        "То включаюсь, то выгораю — скачки энергии. (🎭 Циклотимный)",
        "Спокойно адаптируюсь, распределяю силы. (☯ Сбалансированный)"
    ]
