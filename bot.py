...
RESULTS = {
    "creative": """💡 Креативный фокус

Ты живёшь идеями и вдохновением.
Фокус включается, когда есть эмоция и новизна.
Твой вкус — 🍐 Груша–Пармезан.
Неожиданное сочетание, как твой подход к задачам.""",
    
    "analytical": """🧠 Аналитический фокус

Твоя сила — концентрация и порядок.
Ты глубоко вникаешь в детали и всегда видишь структуру.
Твой вкус — 🍫 Брауни.
Глубокий и уверенный — как твой фокус.""",
    
    "energetic": """⚡️ Энергетический фокус

Ты действуешь быстро, заряжаешь других и двигаешь вперёд.
Твой фокус — в движении и энергии.
Твой вкус — 🍯 Солёная карамель.
Сбалансированный заряд сладости и силы."""
}
