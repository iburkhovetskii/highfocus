...
Хочешь узнать, какой у тебя **тип фокуса** — и какой **вкус** High Focus выбрать? ⚡️
...
ANSWER_TEXTS = {
    "q1_compulsive": "Быстро собираюсь, делаю план и иду по нему. (🔒 Компульсивный)",
    "q1_anxious": "Начинаю тревожиться и прокручивать негативные сценарии. (😰 Тревожный)",
    "q1_depressive": "Чувствую упадок и прокрастинирую. (😔 Депрессивный)",
    "q1_impulsive": "Заряжаюсь энергией, но могу вспылить. (🌋 Вспыльчивый)",
    "q1_hyperactive": "Бросаюсь в задачу с азартом, но хаотично. (⚡ Импульсивный)",
    "q1_cyclothymic": "То включаюсь, то выгораю — скачки энергии. (🎭 Циклотимный)",
    "q1_balanced": "Спокойно адаптируюсь, распределяю силы. (☯ Сбалансированный)",
...
TEXT_TO_TYPE = {
    # Вопрос 1
    "Быстро собираюсь, делаю план и иду по нему. (🔒 Компульсивный)": "compulsive",
    "Начинаю тревожиться и прокручивать негативные сценарии. (😰 Тревожный)": "anxious",
    "Чувствую упадок и прокрастинирую. (😔 Депрессивный)": "depressive",
    "Заряжаюсь энергией, но могу вспылить. (🌋 Вспыльчивый)": "impulsive",
    "Бросаюсь в задачу с азартом, но хаотично. (⚡ Импульсивный)": "hyperactive",
    "То включаюсь, то выгораю — скачки энергии. (🎭 Циклотимный)": "cyclothymic",
    "Спокойно адаптируюсь, распределяю силы. (☯ Сбалансированный)": "balanced",
